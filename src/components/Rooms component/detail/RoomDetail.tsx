...
export default function RoomDetail() {
    ...
    const bookedDatesStrings: string[] = bookedDates.map(d => d.toISOString().split('T')[0]);
                ...
                {open && (
                    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
                        <div className="bg-white rounded-lg shadow-lg w-11/12 max-w-md p-6 relative">
                            ...
                            <ReservationCalendar onReservationConfirm={handleReservationConfirm} reservedRooms={bookedDatesStrings as string[]} />
                        </div>
                    </div>
                )}
            </div>
